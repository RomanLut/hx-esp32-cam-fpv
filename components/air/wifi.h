...
constexpr size_t WLAN_OUTGOING_BUFFER_SIZE = 55000;  //have extra 6+7kb, but crashes if buffer is changed to 60k?
#else
constexpr size_t WLAN_OUTGOING_BUFFER_SIZE = 55000;  //use as much free space as possible, leave some space for SD library(~7kb)
#endif
