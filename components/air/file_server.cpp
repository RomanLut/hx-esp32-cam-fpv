...
static esp_err_t configs_handler(httpd_req_t *req)
{
    if(req->method == HTTP_GET)
    {
        ...
        cJSON_AddStringToObject(root,"default_dvr", s_ground2air_config_packet.autostartRecord ? "true" : "false");
    ...
    else
    {
        ...
        {
            s_ground2air_config_packet.autostartRecord = strcmp(default_dvr->valuestring, "true") == 0;
            nvs_args_set("autostartRecord", s_ground2air_config_packet.autostartRecord ? 1 : 0);
        }        
