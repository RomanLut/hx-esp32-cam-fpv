...
static const DRAM_ATTR uint16_t sensor_default_regs[][2] = {
    ...
    {CLOCK_POL_CONTROL, 0x2d},  //VSYNC active High, HREF Active High, gate PCLK under HREF, PCKL Active High
    {0x4713, 0x02},//jpg mode timing 2 select
    {0x4404, 0x34},  //enable gated clock
...
/*
looks like properly y gated...
    {CLOCK_POL_CONTROL, 0x2d},  //VSYNC active High, HREF Active High, gate PCLK under HREF, PCKL Active High
    {0x4713, 0x01},//jpg mode timing 2 select
    {0x4404, 0x34},  //enable gated clock
*/
...
/*
    ...
    //it is not clear what  {0x4404, 0x34}  does
    {CLOCK_POL_CONTROL, 0x2d},  //VSYNC active High, HREF Active High, gate PCLK under HREF, PCKL Active High
    {0x4713, 0x01},//jpg mode timing 2 select
    {0x4404, 0x34},  //enable gated clock
    */
