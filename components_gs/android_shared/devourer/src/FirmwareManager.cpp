...
void FirmwareManager::FirmwareDownload8812() {
  ...
  auto pFirmwareBuf =
      _device.IsRtl8821A() ? array_mp_8821a_fw_nic : array_mp_8812a_fw_nic;
  auto FirmwareLen = _device.IsRtl8821A() ? array_length_mp_8821a_fw_nic
                                          : array_length_mp_8812a_fw_nic;
  ...
  if (IS_FW_HEADER_EXIST_8812(pFirmwareBuf) ||
      IS_FW_HEADER_EXIST_8821(pFirmwareBuf)) {
