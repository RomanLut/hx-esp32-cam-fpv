...
)
{
    ...
    private suspend fun syncNowSafely()
    {
        ...
        catch (error: Throwable)
        {
            ...
            // Keep polling alive so reappearing hardware recovers without an app restart.
    ...
    private suspend fun syncNow() {
        syncMutex.withLock {
            ...
            if (activeDeviceName != null &&
                ...
                // Android can reuse a bus path after a fast replug; the old descriptor is stale.
                teardownActive()
            }
