...
//===================================================================================
//===================================================================================
// Discovers APFPV cameras and manages the Quest Wi-Fi connection and streaming lock.
...
)
{
    ...
    private suspend fun syncNow() {
        ...
        if (searchActive) {
            // Explicit Search must leave the headset disconnected until the user chooses a
            // rendered Connect-to row. Otherwise the retained preferred ID immediately opens
            // another Horizon approval dialog and hides the search results.
    ...
    private fun connectWithNetworkSpecifier(handle: Long, ssid: String) {
        ...
        val callback = object : ConnectivityManager.NetworkCallback() {
            ...
            override fun onUnavailable() {
                ...
                // A rejected or stale Horizon approval must not immediately open the same
                // system dialog again. Leave reconnection to an explicit menu selection.
                awaitingMenuCameraSelection = true
                syncCameraState(findCameraNetworks(), null)
